  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 text-white">
        ...
        {/* Decorative wave */}
        <svg className="absolute bottom-[-1px] left-0 right-0 w-full h-8 text-gray-50" viewBox="0 0 1440 48" preserveAspectRatio="none">
          <path fill="currentColor" d="M0,32L48,26.7C96,21,192,11,288,5.3C384,0,480,0,576,10.7C672,21,768,43,864,45.3C960,48,1056,32,1152,26.7C1248,21,1344,27,1392,29.3L1440,32L1440,48L1392,48C1344,48,1248,48,1152,48C1056,48,960,48,864,48C768,48,672,48,576,48C480,48,384,48,288,48C192,48,96,48,48,48L0,48Z"/>
        </svg>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-8 pb-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {cards.map((card, idx) => (
            ...
            >
              <Link
                href={card.href}
                className="group relative block rounded-2xl bg-white border shadow-sm hover:shadow-md transition-all overflow-hidden"
              >
                ...
                <div className="p-5 flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-xl bg-gray-100 grid place-items-center ring-1 ring-black/5 mb-4 group-hover:scale-105 transition">
                    <img src={card.img} alt="" className="w-10 h-10 object-contain" />
                  </div>
                  ...
                  <span className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-blue-600">
                    Ouvrir <svg width="16" height="16" viewBox="0 0 24 24" className="opacity-80"><path fill="currentColor" d="M13 5l7 7-7 7v-4H4v-6h9V5z"/></svg>
                  </span>
                </div>
              </Link>
            </motion.div>
        ...
        <section className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="rounded-2xl bg-white border p-5">
            ...
            <p className="mt-2 text-sm text-gray-600">Administration ParkX — <a href="mailto:admin@parkx.test" className="text-blue-600">admin@parkx.test</a></p>
          </div>
        </section>
      </main>
    </div>
