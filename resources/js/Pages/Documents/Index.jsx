...
export default function PublicDocumentsIndex({ documents, flash }) {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-4">
                            <h1 className="text-xl font-semibold text-gray-900">Documents Publics</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8 text-center">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Consultez et téléchargez les documents publics mis à disposition par l'administration.
                        Ces documents sont accessibles à tous les utilisateurs ParkX.
                    </p>
                </div>
                            ...
                            <div key={document.id} className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
                                ...
                                <div className="px-6 py-4 bg-gray-50 rounded-b-lg">
                                    <div className="flex items-center gap-3">
                                        <Link
                                            href={route('parkx.documents.show', document.id)}
